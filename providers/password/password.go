...
import (
	...
	"github.com/ouesiengi/auth"
	"github.com/ouesiengi/auth/auth_identity"
	"github.com/ouesiengi/auth/claims"
	"github.com/ouesiengi/auth/providers/password/encryptor"
	"github.com/ouesiengi/auth/providers/password/encryptor/bcrypt_encryptor"
...
func (provider Provider) ConfigAuth(auth *auth.Auth) {
	auth.Render.RegisterViewPath("github.com/ouesiengi/auth/providers/password/views")

	if auth.Mailer != nil {
		auth.Mailer.RegisterViewPath("github.com/ouesiengi/auth/providers/password/views/mailers")
	}
}
